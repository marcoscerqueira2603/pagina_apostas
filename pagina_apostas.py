    ...
    with st.form('form'):
        ...
        with col1:
            if st.form_submit_button('Adicionar Linha 1.5'):
                ...
                # Criando o DataFrame diretamente com os dados transpostos
                dados_cantos_extras_df = pd.DataFrame(novos_dados_cantos_extras_transposto, columns=entradas_2linhas_extras.columns)

                # Adicionando o DataFrame a dados_cantos_extras
                dados_cantos_extras.append(dados_cantos_extras_df)
